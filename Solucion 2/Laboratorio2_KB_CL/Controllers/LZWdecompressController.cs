...
namespace Laboratorio2_KB_CL.Controllers
{
    ...
    [ApiController]
    public class LZWdecompressController : ControllerBase
    {
        Encoding utf8 = Encoding.UTF8;
        // GET: api/<LZWdecompressController>
        [HttpGet]
        ...
        // GET api/<LZWdecompressController>/5
        [HttpGet("{id}")]
        ...
        // POST api/<LZWdecompressController>
        [HttpPost]
        [HttpPost]
        public IActionResult PostFileCompress([FromForm] IFormFile file, [FromRoute] string name)
        {
            ...
            try
            {
                ...
                string textocomprimido = Singleton.Instance.lzw.descomprimirTexto(textoparacomprimir);
        ...
        // PUT api/<LZWdecompressController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<LZWdecompressController>/5
        [HttpDelete("{id}")]
